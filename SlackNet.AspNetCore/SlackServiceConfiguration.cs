...
namespace SlackNet.AspNetCore
{
    public class SlackServiceConfiguration
    {
        ...
        /// <summary>
        /// Take over all OAuth handling with your own handler.
        /// Handlers registered with <c>RegisterOAuthV2RequestHandler</c> will be ignored.
        /// </summary>
        public SlackServiceConfiguration ReplaceOAuthV2RequestHandling(Func<IServiceProvider, IOAuthV2RequestHandler> handlerFactory) =>
            RegisterReplacementHandler<IOAuthV2RequestHandler>(handlerFactory);
        ...
        public SlackServiceConfiguration RegisterOAuthV2RequestHandler(IOAuthV2RequestHandler handler) =>
            RegisterCompositeItem<IOAuthV2RequestHandler>(p => new ResolvedOAuthV2RequestHandler(p, s => handler));

        public SlackServiceConfiguration RegisterOAuthV2RequestHandler(Func<IServiceProvider, IOAuthV2RequestHandler> handlerFactory) =>
            RegisterCompositeItem<IOAuthV2RequestHandler>(p => new ResolvedOAuthV2RequestHandler(p, handlerFactory));
        #endregion
